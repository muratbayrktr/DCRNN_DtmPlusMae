...
class DCRNNSupervisor(object):
    ...
    def __init__(self, adj_mx, **kwargs):
        ...
        if self._kwargs['model'].get('horizon') == 12:
            ...
            minute = "30min"
        name_str = f"DtmPlusMae_{dataset}_{options[self._kwargs.get('use_dtm')]}_{loss_name}_{self._kwargs['train'].get('base_lr')}_{self._kwargs.get('DTM_TH')}_{minute}_{date_of_run}"
